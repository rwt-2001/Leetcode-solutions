...
public:
    Node* solve(vector<vector<int>> &grid, int r1, int r2, int c1, int c2)
    {
        ...
        topLeft = solve(grid, r1, rowMid, c1, colMid);
        
        
        //topRight

        topRight = solve(grid, r1, rowMid, colMid + 1, c2);
        
        
        //bottomLeft

        bottomLeft = solve(grid, rowMid + 1, r2, c1, colMid);
        
        
        //bottomRight

        bottomRight = solve(grid,rowMid + 1, r2, colMid + 1, c2);
